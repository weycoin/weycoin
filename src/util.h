 ...
 */
#ifndef WEYCOIN_UTIL_H
#define WEYCOIN_UTIL_H
...
extern const char * const WEYCOIN_CONF_FILENAME;
extern const char * const WEYCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("weycoin-%s", name);
