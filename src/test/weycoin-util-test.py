...
# Copyright 2016 WEYCOIN developers
...
help_text="""Test framework for weycoin utils.

Runs automatically during `make check`.

Can also be run manually from the src directory by specifying the source directory:

test/weycoin-util-test.py --srcdir='srcdir' [--verbose]
"""
...
if __name__ == '__main__':
    ...
    bctest.bctester(srcdir + "/test/data", "weycoin-util-test.json", buildenv)
