...
#ifndef WEYCOIN_TEST_SCRIPTNUM10_H
#define WEYCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from WeyCoin Core 0.10.0, for cross-comparison.
 */
public:
