...
#define BOOST_TEST_MODULE WeyCoin Test Suite

#include "test_weycoin.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_weycoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
