...
#if defined(NDEBUG)
# error "WeyCoin cannot be compiled without assertions."
#endif

/**
 * Global state
 */
#define PRE_SUBSIDY_HEIGHT 10000
...
const std::string strMessageMagic = "WeyCoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<uint256>& vHashTxnToUncache, bool fDryRun)//TODO--
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s STAK additional fees, %d delta bytes\n",
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    if(pindex->nHeight > chainparams.GetConsensus().MasternodePaymentStartHeight + 7475)
    {
        ...
        else
        {
            ...
            CWeyCoinAddress address(txdestaddr);
