...
#ifndef WEYCOIN_RPCPROTOCOL_H
#define WEYCOIN_RPCPROTOCOL_H
...
enum RPCErrorCode
{
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //! weycoin is not connected
