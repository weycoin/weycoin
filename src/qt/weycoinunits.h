...
#ifndef WEYCOIN_QT_WEYCOINUNITS_H
#define WEYCOIN_QT_WEYCOINUNITS_H
...
/** WeyCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class WeyCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit WeyCoinUnits(QObject *parent);

    /** WeyCoin units.
      @note Source: https://en.weycoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        WAE,
...
typedef WeyCoinUnits::Unit WeyCoinUnit;

#endif // WEYCOIN_QT_WEYCOINUNITS_H
