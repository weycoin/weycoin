...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s weycoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  weycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded weycoin transaction") + "\n" +
              "  weycoin-tx [options] -create [commands]   " + _("Create hex-encoded weycoin transaction") + "\n" +
              "\n";
...
static void MutateTxAddOutPubKey(CMutableTransaction& tx, const std::string& strInput)
{
    ...
    CWeyCoinAddress addr(scriptPubKey);
    ...
    if (bScriptHash) {
        ...
        CWeyCoinAddress redeemScriptAddr(scriptPubKey);
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded weycoin transaction
