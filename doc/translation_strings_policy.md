...
This document provides guidelines for internationalization of the WeyCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `weycoin_en.ts` remains unchanged.
