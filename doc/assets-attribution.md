The following is a list of assets used in the weycoin source and their proper attribution.
...
### Info
* Designer: Jonas Schnelli (based on the original weycoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/weycoin.icns, src/qt/res/src/weycoin.svg,
	src/qt/res/src/weycoin.ico, src/qt/res/src/weycoin.png,
	src/qt/res/src/weycoin_testnet.png, docs/weycoin_logo_doxygen.png,
