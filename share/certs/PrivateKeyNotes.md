...
unlocked to sign the WeyCoin-Qt.app bundle.
...
allowing somebody to distribute a WeyCoin-Qt.app or weycoin-qt-setup.exe with a valid
...
that the weycoin-qt.exe file inside the installer had not been tampered with.
