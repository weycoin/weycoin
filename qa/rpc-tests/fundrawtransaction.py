...
class RawTransactionsTest(WeyCoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid weycoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid weycoin address" in e.error['message'])
