...
function StartThree {
  $WEYCOIND $WEYCOINDARGS $B1ARGS &
  B1PID=$!
  $WEYCOIND $WEYCOINDARGS $B2ARGS &
  B2PID=$!
  $WEYCOIND $WEYCOINDARGS $B3ARGS &
  B3PID=$!
}
