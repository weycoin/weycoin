...
import RPC call and node 0 sends STAK to it. Then other nodes import the
...
In the second part of the test, node 0 sends more STAK to each address, and the
...
class ImportRescanTest(WeyCoinTestFramework):
    def __init__(self):
        super().__init__()
